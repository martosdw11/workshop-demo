...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-48 overflow-hidden rounded-lg border border-outline-variant',
        'bg-surface-container-lowest p-1 text-on-surface shadow-level2',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex min-h-11 cursor-pointer select-none items-center gap-2 rounded-lg px-3 py-2',
